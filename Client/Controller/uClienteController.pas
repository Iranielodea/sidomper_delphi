...
//        FModel.cdsHistoricoOpcao.AsString := 'SOLICITAÇÃO';
...
//    FModel.cdsHistoricoOpcao.AsString := 'CHAMADO';
//    FModel.cdsHistoricoDescricao.AsString := 'Maior Mês:  ' + sChamadoMaiorMes;
//    FModel.cdsHistorico.Post;
//  end;
//
...
//    FModel.cdsHistoricoOpcao.AsString := 'CHAMADO';
//    FModel.cdsHistoricoDescricao.AsString := 'Menor Mês:  ' + sChamadoMenorMes;
//    FModel.cdsHistorico.Post;
//
//    FModel.cdsHistorico.Append;
//    FModel.cdsHistoricoTipo.AsInteger := 1;
...
//    FModel.cdsHistoricoOpcao.AsString := 'CHAMADO';
//    FModel.cdsHistoricoDescricao.AsString := 'Média:  ';
//    FModel.cdsHistorico.Post;
//  end;
//
...
//    FModel.cdsHistoricoOpcao.AsString := 'ATIVIDADE';
//    FModel.cdsHistoricoDescricao.AsString := 'Maior Mês:  ' + sAtividadeMaiorMes;
//    FModel.cdsHistorico.Post;
//  end;
//
...
//    FModel.cdsHistoricoOpcao.AsString := 'ATIVIDADE';
//    FModel.cdsHistoricoDescricao.AsString := 'Menor Mês:  ' + sAtividadeMenorMes;
//    FModel.cdsHistorico.Post;
//
//    FModel.cdsHistorico.Append;
//    FModel.cdsHistoricoTipo.AsInteger := 2;
...
//    FModel.cdsHistoricoOpcao.AsString := 'VISITA';
//    FModel.cdsHistoricoDescricao.AsString := 'Maior Mês:  ' + sVisitaMaiorMes;
//    FModel.cdsHistorico.Post;
//  end;
//
...
//    FModel.cdsHistoricoOpcao.AsString := 'VISITA';
//    FModel.cdsHistoricoDescricao.AsString := 'Menor Mês:  ' + sVisitaMenorMes;
//    FModel.cdsHistorico.Post;
//
//    FModel.cdsHistorico.Append;
//    FModel.cdsHistoricoTipo.AsInteger := 3;
...
//    FModel.cdsHistoricoOpcao.AsString := 'SOLICITAÇÃO';
//    FModel.cdsHistoricoDescricao.AsString := 'Maior Mês:  ' + sSolicitacaoMaiorMes;
//    FModel.cdsHistorico.Post;
//  end;
//
...
//    FModel.cdsHistoricoOpcao.AsString := 'SOLICITAÇÃO';
//    FModel.cdsHistoricoDescricao.AsString := 'Menor Mês:  ' + sSolicitacaoMenorMes;
//    FModel.cdsHistorico.Post;
//
//    FModel.cdsHistorico.Append;
//    FModel.cdsHistoricoTipo.AsInteger := 4;
...
//  dDataAtual := StrToDate('01/09/2016');
  ...
  begin
    ...
    FModel.cdsHistoricoOpcao.AsString := 'ATIVIDADE';
    FModel.cdsHistoricoDescricao.AsString := 'Maior Mês:  ' + sMaiorMes;
    FModel.cdsHistorico.Post;
  end;
  ...
  begin
    ...
    FModel.cdsHistoricoOpcao.AsString := 'ATIVIDADE';
    FModel.cdsHistoricoDescricao.AsString := 'Menor Mês:  ' + sMenorMes;
    FModel.cdsHistorico.Post;
// média
    FModel.cdsHistorico.Append;
    FModel.cdsHistoricoTipo.AsInteger := 2;
  ...
  begin
    ...
    FModel.cdsHistoricoOpcao.AsString := 'ATIVIDADE';
    FModel.cdsHistoricoDescricao.AsString := 'Mês Atual:  ' + FormatDateTime('mm/yyyy', Date);
    FModel.cdsHistorico.Post;
  end;
end;
