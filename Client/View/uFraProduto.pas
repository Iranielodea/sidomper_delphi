...
uses uImagens, uGrade, uProduto, uProdutoController, uDMProduto, uDM, uFuncoesSIDomper;

procedure TFraProduto.Inicializar;
var
  Img: TfrmImagens;
begin
  edtId.SendToBack;
...
function TFraProduto.RetornoSelecao: string;
var
  bPrimeiro: Boolean;
  sMontar: string;
begin
...
procedure TFraProduto.Adiciona;
begin
...
procedure TFraProduto.btnProcClick(Sender: TObject);
begin
...
procedure TFraProduto.Buscar(AId, ACodigo: integer);
var
...
begin
  ...
  try
    ...
    edtId.Text := obj.Model.CDSCadastroProd_Id.AsString;
    edtCodigo.Text := obj.Model.CDSCadastroProd_Codigo.AsString;
    edtNome.Text := obj.Model.CDSCadastroProd_Nome.AsString;
...
procedure TFraProduto.dbTabelaDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  TGrade.Zebrar(dsTabela.DataSet, dbTabela, Sender, Rect, DataCol, Column, State);
end;

procedure TFraProduto.edtCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
