...
type
  TFraDesenvolvedor = class(TFrame)
    edtCodigo: TEdit;
    edtNome: TEdit;
    dbTabela: TDBGrid;
...
procedure TFraDesenvolvedor.Inicializar;
var
  Img: TfrmImagens;
begin
  edtId.SendToBack;
...
function TFraDesenvolvedor.RetornoSelecao: string;
var
  bPrimeiro: Boolean;
  sMontar: string;
begin
...
procedure TFraDesenvolvedor.Adiciona;
begin
...
procedure TFraDesenvolvedor.btnProcClick(Sender: TObject);
begin
...
procedure TFraDesenvolvedor.Buscar(AId, ACodigo: integer);
var
...
procedure TFraDesenvolvedor.dbTabelaDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  TGrade.Zebrar(dsTabela.DataSet, dbTabela, Sender, Rect, DataCol, Column, State);
end;

procedure TFraDesenvolvedor.edtCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
