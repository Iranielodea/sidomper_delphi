...
type
  ...
  private
    ...
    procedure UsuarioPermissaoHorarioSistema();
  public
    { Public declarations }
...
begin
  UsuarioPermissaoHorarioSistema();
...
begin
// 03 - Resumo de Visitas por Usuário
...
procedure TfrmVisita.UsuarioPermissaoHorarioSistema;
var
  Usuario: TUsuarioController;
begin
  Usuario := TUsuarioController.Create;
  try
    Usuario.HorarioAcessoSistema('','', dm.IdUsuario);
  finally
    FreeAndNil(Usuario);
  end;
end;
