...
procedure TFraOperador.Inicializar;
var
  Img: TfrmImagens;
begin
  edtId.SendToBack;
...
function TFraOperador.RetornoSelecao: string;
var
  bPrimeiro: Boolean;
  sMontar: string;
begin
...
procedure TFraOperador.Adiciona;
begin
...
procedure TFraOperador.btnProcClick(Sender: TObject);
begin
...
procedure TFraOperador.Buscar(AId, ACodigo: integer);
var
...
procedure TFraOperador.dbTabelaDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  TGrade.Zebrar(dsTabela.DataSet, dbTabela, Sender, Rect, DataCol, Column, State);
end;

procedure TFraOperador.edtCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
