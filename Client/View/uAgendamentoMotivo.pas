...
type
  ...
  private
    ...
    procedure BuscarDataAgendamento;
  public
    { Public declarations }
...
procedure TfrmAgendamentoMotivo.BuscarDataAgendamento;
var
  Controller: TAgendamentoController;
begin
  Controller := TAgendamentoController.Create;
  try
    Controller.LocalizarId(FIdAgendamento);
    edtData.Text := Controller.Model.CDSCadastroAge_Data.AsString;
  finally
