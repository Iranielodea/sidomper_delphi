...
procedure TFraUsuario.Inicializar;
var
  Img: TfrmImagens;
begin
  edtId.SendToBack;
...
function TFraUsuario.RetornoSelecao: string;
var
  bPrimeiro: Boolean;
  sMontar: string;
begin
...
procedure TFraUsuario.Adiciona;
begin
...
procedure TFraUsuario.btnProcClick(Sender: TObject);
begin
...
procedure TFraUsuario.Buscar(AId, ACodigo: integer);
var
...
procedure TFraUsuario.dbTabelaDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  TGrade.Zebrar(dsTabela.DataSet, dbTabela, Sender, Rect, DataCol, Column, State);
end;

procedure TFraUsuario.edtCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
