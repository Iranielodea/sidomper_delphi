...
procedure TFraColaborador.Inicializar;
var
  Img: TfrmImagens;
begin
  edtId.SendToBack;
...
function TFraColaborador.RetornoSelecao: string;
var
  bPrimeiro: Boolean;
  sMontar: string;
begin
...
procedure TFraColaborador.Adiciona;
begin
...
procedure TFraColaborador.btnProcClick(Sender: TObject);
begin
...
procedure TFraColaborador.Buscar(AId, ACodigo: integer);
var
...
procedure TFraColaborador.dbTabelaDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  TGrade.Zebrar(dsTabela.DataSet, dbTabela, Sender, Rect, DataCol, Column, State);
end;

procedure TFraColaborador.edtCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
