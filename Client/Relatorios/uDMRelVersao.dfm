object DMRelVersao: TDMRelVersao
  ...
  object dbRelVersao: TppDBPipeline
    ...
    Left = 192
    Top = 24
    object dbRelVersaoppField1: TppField
      FieldAlias = 'Ver_Id'
      FieldName = 'Ver_Id'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object dbRelVersaoppField2: TppField
    ...
    object dbRelVersaoppField3: TppField
      FieldAlias = 'Sol_Tipo'
      FieldName = 'Sol_Tipo'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object dbRelVersaoppField4: TppField
      FieldAlias = 'Tip_Nome'
      FieldName = 'Tip_Nome'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object dbRelVersaoppField5: TppField
    ...
    object dbRelVersaoppField6: TppField
  ...
  object dbRelVersaoDoc: TppDBPipeline
    ...
    Left = 192
    Top = 72
    object dbRelVersaoDocppField1: TppField
      FieldAlias = 'Ver_Id'
      FieldName = 'Ver_Id'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object dbRelVersaoDocppField2: TppField
      FieldAlias = 'Ver_Versao'
      FieldName = 'Ver_Versao'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object dbRelVersaoDocppField3: TppField
      FieldAlias = 'Sol_Tipo'
      FieldName = 'Sol_Tipo'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object dbRelVersaoDocppField4: TppField
    ...
    object dbRelVersaoDocppField5: TppField
      FieldAlias = 'Mod_Nome'
      FieldName = 'Mod_Nome'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object dbRelVersaoDocppField6: TppField
    ...
    object dbRelVersaoDocppField7: TppField
    ...
    object dbRelVersaoDocppField8: TppField
      FieldAlias = 'Prod_Id'
      FieldName = 'Prod_Id'
      FieldLength = 0
      DataType = dtNotKnown
