...
begin
  ...
  if AFiltro.sEmpresaVinculada = 'S' then
    sConsulta := sConsulta + ' AND Cli_EmpresaVinculada > 0';

  if AFiltro.sEmpresaVinculada = 'N' then
    sConsulta := sConsulta + ' AND ((Cli_EmpresaVinculada = 0) OR (Cli_EmpresaVinculada IS NULL))';
