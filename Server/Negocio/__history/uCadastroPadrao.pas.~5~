...
uses
  ...
  uDepartamentoAcesso, uRamal, uRecado, uEscala, uCidade, uFeriado, uCategoria,
  uTabPreco;
...
begin
  case Programa of
   ...
   1051: Result := TDepartamentoAcesso.Create;
    ...
    123: Result := TFeriado.Create;
    124: Result := TCategoria.Create;
    125: Result := TTabPreco.Create;
  end;
end;
