...
begin
  lista := TObjectList<TRecadoQuadroViewModel>.Create();

  AQuery.First;
  while not AQuery.Eof do
  begin
    viewModel := TRecadoQuadroViewModel.Create;
    viewModel.TipoLan             := AQuery.FieldByName('Tipo').AsString;
    viewModel.Id                  := AQuery.FieldByName('Rec_Id').AsInteger;
    viewModel.Data                := AQuery.FieldByName('Rec_Data').AsDateTime;
    viewModel.Nivel               := AQuery.FieldByName('Rec_Nivel').AsInteger;
    viewModel.RazaoSocial         := AQuery.FieldByName('Rec_RazaoSocial').AsString;
    viewModel.Telefone            := AQuery.FieldByName('Rec_Telefone').AsString;
    viewModel.Hora                := AQuery.FieldByName('Rec_Hora').AsDateTime;
    viewModel.Rec_UsuarioLcto     := AQuery.FieldByName('Rec_UsuarioLcto').AsInteger;
    viewModel.Rec_UsuarioDestino  := AQuery.FieldByName('Rec_UsuarioDestino').AsInteger;
    viewModel.UsuarioLcto         := AQuery.FieldByName('UsuarioLcto').AsString;
    viewModel.UsuarioDestino      := AQuery.FieldByName('UsuarioDestino').AsString;
