...
interface
  ...
  const CConsulta: string =
     'SELECT Distinct ModR_Id, ModR_Codigo, ModR_Descricao, ModR_Arquivo FROM Modelo_Relatorio'
    +' LEFT JOIN Revenda ON ModR_Revenda = Rev_Id '
    +' LEFT JOIN Usuario ON ModR_Revenda = Usu_Revenda';
