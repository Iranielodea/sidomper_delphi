...
//------------------------------------------------------------------------------
    ...
    function RelatorioModelo_08(Filtro: TFiltroVisita; IdUsuario: integer; Ordem:
        string): string;
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      model.Perfil := obj.Model.FieldByName('Cli_Perfil').AsString;
...
function TVisita.RelatorioModelo_08(Filtro: TFiltroVisita; IdUsuario: integer;
  Ordem: string): string;
var
  sConsulta: string;
  lRelatorio: TDMVisita;
begin
  ...
  lRelatorio := TDMVisita.Create(nil);
  try
    Result := lRelatorio.QRelVisitaModelo08.SQL.Text + sConsulta;
  finally
    FreeAndNil(lRelatorio);
  end;
end;
