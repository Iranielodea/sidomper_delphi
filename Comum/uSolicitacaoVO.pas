...
type
  ...
  private
    ...
    FContato: string;
    FIdCliente: Integer;
    FDescricaoLiberacao: AnsiString;
    ...
    procedure SetDescricaoLiberacao(const Value: AnsiString);
  ...
  public
    ...
    property DescricaoLiberacao: AnsiString read FDescricaoLiberacao write SetDescricaoLiberacao;
...
begin
  ...
  FSolicitacoesStatus := TObjectList<TSolicitacaoStatusVO>.Create();
//  FSolicitacoesTempos := TObjectList<TSolicitacaoTempoVO>.Create(nil);
  FSolicitacoesCronogramas := TObjectList<TSolicitacaoCronogramaVO>.Create();
  FSolicitacoesOcorrencias := TObjectList<TSolicitacaoOcorrenciaVO>.Create();
end;
...
procedure TSolicitacaoVO.SetDescricaoLiberacao(const Value: AnsiString);
begin
