...
type
  ...
  public
    ...
    procedure RelatorioVersao(AModelo: Integer; AIdVersao: Integer; out AQtdeRetorno: Integer);
...
procedure TServerMethods1Client.RelatorioVersao(AModelo: Integer; AIdVersao: Integer; out AQtdeRetorno: Integer);
begin
